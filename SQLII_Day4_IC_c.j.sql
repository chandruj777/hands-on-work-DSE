...
where first_name = 'monica';#1000 rs is deducted from monica's balance.

update account_details
set balance = balance + 1000
where first_name = 'joseph';#1000 rs is added in joseph's bank account balance.
...
update bank_customer set telephone = null
...
#theory questions are asked in transaction topic.it is optional.
